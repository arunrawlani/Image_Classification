# Code based on Nielsen's book found here:
# http://neuralnetworksanddeeplearning.com/chap1.html
# The following is Nielsen's original comment:
# ----------------------
...
class Network(object):
    ...
    # Update network based on backprop on a single mini batch
    ...
    # Number of inputs that the NN predicted correctly
